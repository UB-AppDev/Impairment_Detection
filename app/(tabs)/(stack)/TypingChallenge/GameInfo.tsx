...
export default function TypingChallangeGameInfo() {
    ...
    return (
        <View style={styles.screenContainer}>
          ...
          <View style={styles.infoBox}>
            <Text style={styles.sectionTitle}>Typing Challange</Text>
            <Text style={styles.description}>
                You will be presented with a series of phrases. Please type them as accurately and quickly as possible. Continue to type until time runs out.            </Text>
